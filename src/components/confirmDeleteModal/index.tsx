...
import { IConfirmDeleteModalProps } from './IConfirmDeleteModalProps';
...
export function ConfirmDeleteModal(props: IConfirmDeleteModalProps) {
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                This data will be permanently deleted. Do you confirm that?
            </DialogContent>
            <DialogActions>
                <ActionGroup>
                    ...
                    <BootstrapButton onClick={handleConfirm} variant='contained' color='error' disabled={isLoading}>
                        <DeleteForever />
                        Delete
                    </BootstrapButton>
                </ActionGroup>
