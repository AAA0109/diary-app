...
export const useMicros = (container: Container) => {
    ...
    container.bind<IDiaryService>(SocialProviderTypes.DiaryService).to(DiaryService);
    container.bind<IChatService>(SocialProviderTypes.ChatService).to(ChatService);
    container.bind<ICommunityService>(SocialProviderTypes.CommunityService).to(CommunityService);
};
