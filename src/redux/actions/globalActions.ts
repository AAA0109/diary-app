 ...
 * Set header title
 */
export const setNavigationStep = (step: number): any => {
    return {
        type: GlobalActionType.SET_NAVIGATION_STEP,
        payload: step,
    };
};
 ...
 * Set user emotion
 */
export const setEmotion = (emotion: string): any => {
    userService.setUserEmotion(emotion);
    return {
        type: GlobalActionType.SET_EMOTION,
        payload: emotion,
    };
};
