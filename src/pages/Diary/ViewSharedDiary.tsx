...
import SharedDiaryPaneComponent from 'components/diary/diaryPane/shared';


export default function ViewSharedDiary() {
        ...
        <RootStyle>
            {
                loadingDiary ?
                    ...
                    <SharedDiaryPaneComponent diary={diary} updateDiaryList={updateDiaryList} updateDiary={updateDiary} canExpand={false} isExpand={true} showComments={true} />
            }
        </RootStyle>
    );
}
