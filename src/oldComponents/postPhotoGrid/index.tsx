                ...
                <div className={classes.container}>
                    <div
                        className={classNames(
                            { [classes.firstColumn]: photoDisplay === 1 },
                            { [classes.firstRow]: photoDisplay === 2 },
                        )}
                    >
                        <CardMedia
                            image={images[0].url}
                            onClick={(event) => this.handleClick(event, 0)}
                            className={classNames(classes.mediaCard, classes.featureCard)}
                        />
                    </div>
                    <div
                        className={classNames(
                            { [classes.column]: photoDisplay === 1 },
                            { [classes.row]: photoDisplay === 2 },
                        )}
                    >
